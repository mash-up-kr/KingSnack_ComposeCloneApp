package com.example.kingsnack.ui.theme
...
private val DarkColorPalette = KingsnackColors(
    brand = Shadow1,
...
private val LightColorPalette = KingsnackColors(
    brand = Shadow5,
...
object KingsnackColorTheme {
    val colors: KingsnackColors
        @Composable
        get() = LocalKingsnackColors.current
}

@Composable
fun KingSnackTheme(darkTheme: Boolean = isSystemInDarkTheme(), content: @Composable () -> Unit) {
    ...
    ProvideKingsnackColors(colors = colors) { //
        MaterialTheme(
...
class KingsnackColors(
    ...
    fun update(other: KingsnackColors) {
    ...
    fun copy(): KingsnackColors = KingsnackColors(
...
@Composable
fun ProvideKingsnackColors(
    colors: KingsnackColors,
    ...
    CompositionLocalProvider(LocalKingsnackColors provides colorPalette, content = content)
}

private val LocalKingsnackColors = staticCompositionLocalOf<KingsnackColors> {
    error("No KingsnackColorPalette providied")
}
